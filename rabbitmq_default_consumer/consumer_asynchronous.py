...
class consume_engine:
    ...
    def on_declare(self, channel):
        ...
        # message consumption from queue, on_message has to be called every time we receive message
        # QUEUE is the queue we want to consume messages from
    ...
    # basic_deliver provides details about the message
    # properties we sent with our publisher
    ...
    # Create our connection object, passing in the on_open method
        ...
        # on_open_callback has the be invoked on successful connection
